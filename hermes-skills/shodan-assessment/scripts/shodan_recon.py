...
TEMPLATES = {
 "secrets_manager": ("Internet-facing secrets / password manager",
   ...
   [{"tag":"COLT","title":"SASE / ZTNA — remove the vault from the public internet",
    ...
    {"tag":"COLT","title":"Managed Security Service — patch orchestration prioritised by KEV/EPSS",
     "body":"WHY COLT: vault CVEs are exploited in days, faster than a quarterly maintenance window. WHAT YOU GET: the vault tracked as a tier-0 asset with emergency patch SLAs. HOW: KEV/EPSS-driven prioritisation with operated change execution."},
 ...
 "backup_console": ("Internet-facing backup / recovery console",
   ...
   [{"tag":"COLT","title":"SASE / ZTNA — the backup plane must never be internet-reachable",
     "body":"WHY COLT: the console stores credentials for the whole estate, so exposure is a full-estate risk, not a single-host one. WHAT YOU GET: administrative access brokered per identity with MFA and session logging. HOW: ZTNA, no published port."},
 ...
 "pbx_exposed": ("Internet-facing PBX / telephony management",
   ...
   [{"tag":"COLT","title":"SASE / ZTNA — publish the PBX web client only to enrolled users",
    ...
    {"tag":"COLT","title":"Managed Voice / SIP trunking — carrier-side fraud controls",
     "body":"WHY COLT: destination and spend limits stop toll fraud at the carrier, not after the invoice. WHAT YOU GET: capped exposure with anomaly alerting. HOW: SIP trunk policy plus monitoring."},
    {"tag":"COLT","title":"Managed Firewall — restrict SIP and mgmt to known peers",
     "body":"WHY COLT: SIP needs a handful of peers, never 0.0.0.0/0. WHAT YOU GET: registrar brute-force eliminated. HOW: managed allowlist."}],
