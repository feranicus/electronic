...
export const keyed = {
  ...
  "admin.tabFleet": "Parc",
  "fleet.h": "Sidecar de sécurité sur tous les projets",
  "fleet.refresh": "Actualiser",
  "fleet.guarded": "protégés",
  "fleet.blindN": "non visibles",
  "fleet.unguardedN": "non protégés",
  "fleet.cycle": "cycle de règles",
  "fleet.blindWarn": "Aucune ligne de journal dans la fenêtre pour :",
  "fleet.project": "Projet",
  "fleet.state": "État",
  "fleet.sidecar": "Sidecar",
  "fleet.req": "Requêtes",
  "fleet.att": "Forme d'attaque",
  "fleet.vis": "Visiteurs",
  "fleet.cli": "Bots et outils",
  "fleet.vsUnknown": "non determinable",
  "fleet.vsAddr": "Adresses distinctes :",
  "fleet.vsUnjudged": "Adresses sans preuve cote client :",
  "fleet.vs.measured": "Chaque ligne de requete portait la preuve, cette repartition les couvre donc toutes.",
  "fleet.vs.partial": "Certaines lignes de requete ne portaient aucune preuve ; ces adresses ne sont comptees dans aucune des deux colonnes.",
  "fleet.vs.none": "Aucune ligne de requete ne portait la preuve, visiteurs et outils ne peuvent donc pas etre separes pour ce projet. C'est notre angle mort, pas un projet calme.",
  "fleet.alerts": "Alertes",
  "fleet.lastSeen": "Dernière ligne",
  "fleet.beat": "dernier battement",
  "fleet.s.live": "actif",
  "fleet.s.observed": "observé",
  "fleet.s.silent": "silencieux",
  "fleet.s.elsewhere": "ailleurs",
  "fleet.elsewhereN": "journal propre",
  "fleet.sc.active": "actif",
  "fleet.sc.stale": "obsolète",
  "fleet.sc.not_installed": "non installé",
  "fleet.sc.unverifiable": "non vérifiable ici",
  "fleet.loading": "Lecture du journal d'événements partagé…",
  "fleet.loadFail": "Impossible de lire l'état du parc.",
  "fleet.window": "Fenêtre :",
  "fleet.socH": "Ce qui est réellement appliqué",
  "fleet.socLede": "Tout ce qui précède relève de l'observation. Cette section indique si quelque chose serait réellement bloqué et si une attaque vous parviendrait.",
  "fleet.enforcingN": "projets qui appliquent des règles",
  "fleet.alertBlindN": "projets qui n'alertent personne",
  "fleet.blCycle": "Cycle du jeu de règles :",
  "fleet.blPatterns": "règles de blocage :",
  "fleet.blAge": "écrit :",
  "fleet.blUnread": "La liste de blocage publiée n'a pas pu être lue ici, son cycle et son nombre de règles sont donc inconnus. C'est notre angle mort, pas une affirmation sur perseus.",
  "fleet.blNever": "Aucune liste de blocage n'a jamais été publiée. Le cycle 0 signifie qu'aucune exécution nocturne ne s'est jamais terminée : chaque sidecar compare à une liste de règles vide et rien n'est bloqué sur ce parc.",
  "fleet.pubOff": "La consultation du journal de publication est désactivée sur cette machine (PERSEUS_LOKI_PUBLISH) ; nous n'avons donc pas demandé si le cerveau avait tourné.",
  "fleet.pubPending": "La consultation du journal de publication n'a pas encore terminé une requête ; savoir si le cerveau a tourné reste inconnu.",
  "fleet.pubNoAnswer": "Loki a été interrogé sur le journal de publication et n'a pas répondu ; savoir si le cerveau a tourné reste inconnu.",
  "fleet.pubNone": "Loki a répondu et ne contient aucune ligne de publication sur la fenêtre : le cerveau n'a pas publié une seule fois.",
  "fleet.pubRuns": "publications enregistrées sur la fenêtre",
  "fleet.pubFailed": "dont en échec",
  "fleet.colSoc": "SOC IA",
  "fleet.colTg": "Telegram",
  "fleet.soc.active": "actif",
  "fleet.soc.partial": "partiel",
  "fleet.soc.off": "inactif",
  "fleet.soc.unknown": "inconnu",
  "fleet.socNext": "Prochaine étape :",
  "fleet.colEnforce": "Application",
  "fleet.colRules": "Règles",
  "fleet.colAlerting": "Alertes",
  "fleet.colRefused": "Refusées (24 h)",
  "fleet.e.unknown": "inconnu",
  "fleet.e.none": "aucun jeu de règles",
  "fleet.e.armed": "jeu de règles chargé",
  "fleet.e.empty": "aucune règle",
  "fleet.e.active": "applique",
  "fleet.a.self": "alertes propres",
  "fleet.a.covered": "couvert",
  "fleet.a.unknown": "inconnu",
  "fleet.a.blind": "n'atteint personne",
  "fleet.a.selfWhy": "cybergod.ai exécute lui-même les règles de détection et les notifications.",
  "fleet.a.coveredWhy": "Ses lignes parviennent à cybergod, qui leur applique la même détection et vous alerte.",
  "fleet.a.unknownWhy": "Ses lignes n'étaient pas dans le cache que lit cette page. La boucle d'alerte lit la même source mais l'attend : cette page ne peut donc pas se prononcer.",
  "fleet.a.blindWhy": "Rien ne transporte les lignes de ce projet vers cybergod ; une attaque n'alerterait personne.",
  "fleet.unknown": "inconnu",
  "fleet.tarpitNote": "Le ralentissement (tarpit) n'écrit aucune ligne dans les journaux : cette page ne peut donc pas déterminer combien de fois une requête a été ralentie.",
  "side.admin": "Gestion",
  "side.password": "Mot de passe",
  "admin.h1": "Administration",
  "admin.lede": "Créez des utilisateurs, attribuez et réinitialisez les mots de passe, et voyez qui peut accéder à cybergod.ai. La connexion exige toujours le code à 6 chiffres envoyé par e-mail.",
  "admin.email": "ADRESSE E-MAIL",
  "admin.password": "MOT DE PASSE",
  "admin.pwPlaceholder": "laisser vide pour en générer un",
  "admin.pwHint": "Au moins {n} caractères. Affiché une seule fois, jamais stocké en clair.",
  "admin.note": "NOTE",
  "admin.notePlaceholder": "ex. partenaire, évaluation",
  "admin.issue": "Enregistrer",
  "admin.issuedH": "Mot de passe défini. Il n'est affiché que maintenant.",
  "admin.copy": "Copier",
  "admin.dismiss": "Terminé",
  "admin.issuedNote": "Transmettez-le par un canal de confiance. Il n'est pas envoyé par e-mail : le code à usage unique prouve déjà le contrôle de cette boîte, y envoyer aussi le mot de passe réunirait les deux facteurs au même endroit. S'il est perdu, définissez-en un nouveau.",
  "admin.usersH": "Qui peut accéder à la plateforme",
  "admin.search": "Filtrer par adresse",
  "admin.colEmail": "Adresse",
  "admin.colAccess": "Identifiant",
  "admin.colState": "État",
  "admin.colLast": "Dernière connexion",
  "admin.colRuns": "Évaluations",
  "admin.colActions": "Actions",
  "admin.tagAdmin": "administrateur",
  "admin.tagAssigned": "attribué",
  "admin.tagShared": "mot de passe partagé",
  "admin.tagNotAllowed": "hors liste d'accès",
  "admin.tagDisabled": "désactivé",
  "admin.tagMustChange": "à changer",
  "admin.tagActive": "actif",
  "admin.enable": "Activer",
  "admin.disable": "Désactiver",
  "admin.remove": "Retirer",
  "admin.confirmRemove": "Retirer le mot de passe attribué à {email} ? Si l'adresse reste sur la liste d'accès, le mot de passe partagé redevient valable.",
  "admin.removeNote": "Retirer un mot de passe attribué ne révoque pas l'accès à soi seul : une adresse encore sur la liste revient au mot de passe partagé. Désactivez le compte pour empêcher la connexion.",
  "admin.sharedActive": "Un mot de passe d'accès partagé est toujours configuré. Toute personne sur la liste sans mot de passe attribué peut l'utiliser.",
  "admin.storeDown": "Le magasin d'identifiants ne peut pas être ouvert, les mots de passe attribués ne peuvent donc pas être vérifiés. Ceux qui en ont un sont refusés plutôt que renvoyés vers le mot de passe partagé.",
  "admin.none": "Aucun utilisateur pour l'instant.",
  "admin.loading": "Chargement…",
  "admin.forbidden": "Cette page est réservée aux administrateurs.",
  "admin.loadFail": "Impossible de charger la liste des utilisateurs.",
  "admin.saveFail": "Cela n'a pas fonctionné.",
  "pw.h1": "Changer votre mot de passe",
  "pw.h1Forced": "Définir votre propre mot de passe",
  "pw.lede": "Votre mot de passe est distinct du code à usage unique, toujours exigé à chaque connexion.",
  "pw.ledeForced": "Le mot de passe qui vous a été remis est temporaire. Choisissez le vôtre pour continuer.",
  "pw.current": "MOT DE PASSE ACTUEL",
  "pw.new": "NOUVEAU MOT DE PASSE",
  "pw.repeat": "RÉPÉTER LE NOUVEAU MOT DE PASSE",
  "pw.save": "Enregistrer",
  "pw.mismatch": "Les deux nouveaux mots de passe ne correspondent pas.",
  "pw.fail": "Le mot de passe n'a pas été changé.",
  "pw.hint": "Au moins 12 caractères. Personne, pas même un administrateur, ne peut le relire ensuite.",
  ...
  "guard.title": "Contenu protégé",
  "guard.body": "Le clic droit et les raccourcis d'affichage du code source sont désactivés sur ce site. La méthodologie d'évaluation, les textes et les visuels sont la propriété intellectuelle de Cybergod LLC / S4Biz Group.",
  ...
  "wl.h1": "White Label",
  "wl.lede": "Importez votre propre modèle PowerPoint : chaque présentation et rapport généré ensuite reprendra vos couleurs, vos polices et votre logo.",
  "wl.template": "Votre modèle PowerPoint",
  "wl.uploadHint": ".pptx ou .potx. Nous y lisons les couleurs, les polices et le logo, et ne conservons pas le fichier.",
  "wl.logo": "Logo (facultatif)",
  "wl.logoHint": "PNG, JPEG, GIF ou WebP, jusqu’à {n} Ko. Laissez vide pour utiliser le logo trouvé dans le modèle.",
  "wl.name": "Nom sur les documents",
  "wl.namePlaceholder": "Acme Security GmbH",
  "wl.save": "Appliquer l’identité",
  "wl.saving": "Lecture du modèle…",
  "wl.remove": "Retirer l’identité",
  "wl.confirmRemove": "Retirer votre identité ? Les prochains documents utiliseront le design de cybergod.ai.",
  "wl.none": "Aucune identité pour l’instant. Vos documents utilisent le design de cybergod.ai.",
  "wl.active": "active",
  "wl.palette": "Couleurs lues dans votre modèle",
  "wl.stopLight": "Accent clair",
  "wl.stopMid": "Intermédiaire",
  "wl.stopDark": "Fond sombre",
  "wl.tune": "Corrigez ces valeurs si nous les avons mal lues",
  "wl.tuneHint": "Hexad\u00e9cimal \u00e0 six chiffres. Ce que vous saisissez l'emporte sur notre lecture, et l'aper\u00e7u ci-dessous est une vraie couverture construite avec.",
  "wl.previewH": "Votre couverture, telle qu'elle sera construite",
  "wl.previewHint": "C'est la diapositive que le g\u00e9n\u00e9rateur produit r\u00e9ellement avec ces r\u00e9glages, pas une maquette.",
  "wl.refresh": "Actualiser l'aper\u00e7u",
  "wl.fontsKept": "Votre fichier ne contient aucune police de marque, les rapports conservent donc les leurs.",
  "wl.fonts": "Polices",
  "wl.decided": "Comment cela a été décidé",
  "wl.colModel": "Modèle IA",
  "wl.colVote": "Choix",
  "wl.voteNone": "pas de réponse",
  "wl.warnings": "À savoir",
  ...
  "wl.chipNone": "Les documents utilisent le design de cybergod.ai.",
